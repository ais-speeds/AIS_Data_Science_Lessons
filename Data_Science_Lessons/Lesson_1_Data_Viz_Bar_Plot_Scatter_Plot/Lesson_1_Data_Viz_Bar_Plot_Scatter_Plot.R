...
# ---- Scatter Plot 1 ----
### Matildas - NPxG per 90 vs Shots per 90, colored by average distance, shaped by goal scoring

#* Filter the data to only include shots by the Matildas ----
...
#* Shots, NPxG, average shot distance, 'scored or not' for each player ----
...
#* Normalize all metrics per 90 minutes ----
...
# ---- Scatter Plot 2 ----
###  Generate tiled shot maps for the Matildas 
...
#* Value added in attack per 90 min for each player ----
...
# Here we want to annotate two particular penalty shots from the Australia v France FWWC23 quarterfinal
# One penalty by Mackenzie Arnold and one by Cortnee Vine - two memorable penalty shots for all Aussies
